...
@Inject
class integrationManageForConfig {
    constructor($scope,$stateParams, $state,$timeout, $q, $rootScope,$interval,HttpService,DialogService,$sce,DetecEnv) {
        ...
        vm.url = $sce.trustAsResourceUrl(uranusUrl+'/#/buildConfig/'+appId);
    }
}

export default app => app.controller('integrationManageForConfig', integrationManageForConfig);