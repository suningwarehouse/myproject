...
@Inject
class integrationManageForDocker {
    constructor($scope,$stateParams, $state,$timeout, $q, $rootScope,$interval,HttpService,DialogService,$sce,DetecEnv) {
        ...
        vm.url = $sce.trustAsResourceUrl(uranusUrl+'/#/dockerImage/'+appId);
    }
}

export default app => app.controller('integrationManageForDocker', integrationManageForDocker);